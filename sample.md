...
![GitHub 图标](./images/github-icon.svg)

### 4.2 带标题的图片

![这是一张示例图](./images/placeholder-300x100.svg "图片标题")

### 4.3 图片作为链接

[![点击图片跳转](./images/placeholder-200x60.svg)](https://www.example.com)
...
<img src="./images/placeholder-400x50.svg" width="200" />

### 4.6 带对齐的图片（HTML）

<div align="center">
  <img src="./images/placeholder-200x50.svg" />
</div>

### 4.7 Base64 内嵌图片（无需外部文件）

![base64-embedded](data:image/svg+xml;base64,)

*上图通过 `data:image/svg+xml;base64,...` 内嵌，不依赖任何外部文件。*
...
- 包含图片：
  ![小图标](./images/placeholder-20x20.svg)
...
[placeholder]: ./images/placeholder-150x50.svg
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <img src="./images/placeholder-80x30.svg" alt="cell img" />
      </td>
